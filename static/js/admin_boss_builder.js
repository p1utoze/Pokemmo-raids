let movesData = [];
    ...
    function renderVariationCarousel() {
        ...
        if (variationsData.length === 0) {
            container.innerHTML = '<p style="color: var(--muted); text-align: center;">No variations yet. Click "+ Add Variation" to start.</p>';
        ...
        ['P1', 'P2', 'P3', 'P4'].forEach(player => {
            ...
            playerTable.style.cssText = 'margin-bottom: 16px; padding: 12px; background: rgba(255,255,255,0.05); border-radius: 4px;';

            const playerTitle = document.createElement('h5');
            playerTitle.textContent = player;
            playerTitle.style.cssText = 'margin: 0 0 8px 0; color: var(--accent);';
